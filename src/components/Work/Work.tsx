        ...
        <div className="h-screen">
            ...
            <div className="grid pb-32 md:min-h-screen mt-28 md:mt-0 place-items-center">
                <div>
                    ...
                    >Mis últimos  <span className="text-fuchsia-500">trabajos realizados.</span>
                    </motion.h1>
                    <motion.div
                                    ...
                                    <div className="card-footer rounded-b-[20px] bg-gray-800 bg-opacity-75 min-h-[100px] flex flex-col items-center justify-center p-3">
                                        ...
                                        {id === expandedIndex && (
                                            ...
                                            <div className="flex gap-5 mt-3">
                                                ...
                                                <a key={index} target="_blank" href={data.gitFront} rel="noopener noreferrer">
                                                <p> {data.icon} FRONT END</p>
                                                </a>
                                                ))}
                                            </div>
                                            <div className="flex gap-5 mt-3">
                                                {skills.map((data, index) => (
                                                <a key={index}  target="_blank" href={data.gitBack} rel="noopener noreferrer">
                                                <p>{data.icon}BACK END</p>
                                                </a>
                                                ))}
                                            </div>
                                            <div className="flex gap-5 mt-3">
                                                {skills.map((data, index) => (
                                                <a key={index}  target="_blank" href={data.host} rel="noopener noreferrer">
                                                <p>{data.icon}LINK HOST</p>
                                                </a>
                                                ))}
                                            </div>
                                        </>
